...
/**
 * A DTO for the DaySummary entity.
 */
public class DaySummaryDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DaySummaryDTO daySummaryDTO = (DaySummaryDTO) o;

        if ( ! Objects.equals(id, daySummaryDTO.id)) { return false; }
